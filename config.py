class Config:
    ...
    FORECAST_USED_FEATURES = ['latitude', 'longitude', 'temperature', 'cloudcover_total', 'direct_solar_radiation',
                              'is_business_0', 'is_business_1', 'product_type_0', 'product_type_1', 'product_type_2',
                              'product_type_3']

    HISTORICAL_BUSINESS_USED_FEATURES = ['latitude', 'longitude', 'temperature', 'cloudcover_total',
                                         'direct_solar_radiation', 'product_type_0', 'product_type_1', 'product_type_2',
                                         'product_type_3']

    HISTORICAL_PRIVATE_USED_FEATURES = ['latitude', 'longitude', 'temperature', 'cloudcover_total',
                                        'direct_solar_radiation', 'product_type_1', 'product_type_2', 'product_type_3']
